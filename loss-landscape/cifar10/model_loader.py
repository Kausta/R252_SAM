...
from cifar10.models.mobilenet import MobileNetV2, MobileNetV3
...
def load(model_name, model_file=None, data_parallel=False):
    ...
    if model_name == 'mobilenetv2' or model_name == 'mobilenetv3':
        assert model_file is not None, "Please specify model file."
        ...
        for key, value in stored['state_dict'].items():
            # print(key[6:])
            new_state_dict[key[6:]] = value # remove "model." prefix from pytorch lightning
        # import ipdb; ipdb.set_trace()
        net = models[model_name](stored['hparams']) # this is the config file
